...
> The bundled `aws.json` points to a public self-hosted instance. To use your own, update the URLs or run your own instance: [sam-fakhreddine/awslocalmcp](https://github.com/sam-fakhreddine/awslocalmcp).
